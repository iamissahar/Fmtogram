...
var messageResponse = map[string]*types.TelegramResponse{methods.Message: new(types.TelegramResponse),
	methods.ForwardMessage:   new(types.TelegramResponse),
	methods.Photo:            new(types.TelegramResponse),
	methods.Audio:            new(types.TelegramResponse),
	methods.Document:         new(types.TelegramResponse),
	methods.Video:            new(types.TelegramResponse),
	methods.Animation:        new(types.TelegramResponse),
	methods.Voice:            new(types.TelegramResponse),
	methods.VideoNote:        new(types.TelegramResponse),
	methods.PaidMedia:        new(types.TelegramResponse),
	methods.Location:         new(types.TelegramResponse),
	methods.Venue:            new(types.TelegramResponse),
	methods.Contact:          new(types.TelegramResponse),
	methods.Poll:             new(types.TelegramResponse),
	methods.Dice:             new(types.TelegramResponse),
	methods.EditText:         new(types.TelegramResponse),
	methods.EditCaption:      new(types.TelegramResponse),
	methods.EditMedia:        new(types.TelegramResponse),
	methods.EditLiveLocation: new(types.TelegramResponse),
	methods.StopLiveLocation: new(types.TelegramResponse),
	methods.EditReplyMarkup:  new(types.TelegramResponse),
	methods.Sticker:          new(types.TelegramResponse),
	methods.Invoice:          new(types.TelegramResponse),
	methods.Game:             new(types.TelegramResponse),
	methods.SetGameScore:     new(types.TelegramResponse),
}

var messageIDsReponse = map[string]*types.TelegramMessageIDs{methods.ForwardMessages: new(types.TelegramMessageIDs),
	methods.CopyMessage:  new(types.TelegramMessageIDs),
	methods.CopyMessages: new(types.TelegramMessageIDs),
}
