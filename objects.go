...
type photo struct {
	...
	CaptionEntities       []*MessageEntity `json:"caption_entities,omitempty" field:"caption_entities" ifempty:"false"`
...
type poll struct {
	...
	QuestionEntities     []*MessageEntity `json:"question_entities,omitempty" field:"question_entities" ifempty:"false"`
	Options              []*PollOption    `json:"options,omitempty" field:"options" ifempty:"false"`
	...
	ExplanationEntities  []*MessageEntity `json:"explanation_entities,omitempty" field:"explanation_entities" ifempty:"false"`
...
type sticker struct {
	...
	MaskPosition        *MaskPosition `json:"mask_position,omitempty" field:"mask_position" ifempty:"false"`
	Thumbnail           string        `json:"thumbnail,omitempty" field:"thumbnail" ifempty:"false"`
...
type information struct {
	...
	Entities                   []*MessageEntity         `json:"entities,omitempty" field:"entities" ifempty:"false"`
	CaptionEntities            []*MessageEntity         `json:"caption_entities,omitempty" field:"caption_entities" ifempty:"false"`
	LinkPreviewOptions         *LinkPreviewOptions      `json:"link_preview_options,omitempty" field:"link_preview_options" ifempty:"false"`
	...
	ShowCaptionAboveMedia      bool                     `json:"show_caption_above_media,omitempty" field:"show_caption_above_media" ifempty:"false"`
	ReplyParameters            *ReplyParameters         `json:"reply_parameters,omitempty" field:"reply_parameters" ifempty:"false"`
	...
	Reaction                   []*ReactionType          `json:"reaction,omitempty" field:"reaction" ifempty:"false"`
	...
	Permissions                *ChatPermissions         `json:"permissions,omitempty" field:"permissions" ifempty:"false"`
	...
	AdminRights                *ChatAdministratorRights `json:"rights,omitempty" field:"rights" ifempty:"false"`
	...
	Errors                     []*PassportElementError  `json:"errors,omitempty" field:"errors" ifempty:"false"`
	GiftParseMode              string                   `json:"text_parse_mode,omitempty" field:"text_parse_mode" ifempty:"false"`
	GiftEntities               []*MessageEntity         `json:"text_entities,omitempty" field:"text_entities" ifempty:"false"`
...
type bot struct {
	Commands         []*BotCommand            `json:"commands,omitempty" field:"commands" ifempty:"false"`
	Scope            *BotCommandScope         `json:"scope,omitempty" field:"scope" ifempty:"false"`
	...
	MenuButtom       *MenuButton              `json:"menu_button,omitempty" field:"menu_button" ifempty:"false"`
	Rights           *ChatAdministratorRights `json:"rights,omitempty" field:"rights" ifempty:"false"`
...
type inlineKeyboardButton struct {
	...
	WebApp                       *WebAppInfo                  `json:"web_app,omitempty" field:"web_app" ifempty:"false"`
	LoginUrl                     *LoginUrl                    `json:"login_url,omitempty" field:"login_url" ifempty:"false"`
	...
	SwitchInlineQueryChosenChat  *SwitchInlineQueryChosenChat `json:"switch_inline_query_chosen_chat,omitempty" field:"switch_inline_query_chosen_chat" ifempty:"false"`
	CallbackGame                 *CallbackGame                `json:"callback_game,omitempty" field:"callback_game" ifempty:"false"`
...
type replyKeyboardButton struct {
	Text            string                      `json:"text,omitempty" field:"text" ifempty:"false"`
	RequestUsers    *KeyboardButtonRequestUsers `json:"request_users,omitempty" field:"request_users" ifempty:"false"`
	RequestChat     *KeyboardButtonRequestChat  `json:"request_chat,omitempty" field:"request_chat" ifempty:"false"`
	...
	RequestPoll     *KeyboardButtonPollType     `json:"request_poll,omitempty" field:"request_poll" ifempty:"false"`
	WebApp          *WebAppInfo                 `json:"web_app,omitempty" field:"web_app" ifempty:"false"`
	storage         [6]int
}
...
type inlinemode struct {
	...
	Button            *InlineQueryResultsButton `json:"button,omitempty" field:"button" ifempty:"false"`
	...
	webAppResponse    *SentWebAppMessage
	inMessageResponse *PreparedInlineMessage
	resultcounter     int
	onlytothearray    bool
}
...
type payment struct {
	...
	Prices                    []*LabeledPrice   `json:"prices,omitempty" field:"prices" ifempty:"false"`
	...
	ShippingOptions           []*ShippingOption `json:"shipping_options,omitempty" field:"shipping_options" ifempty:"false"`
...
type gift struct {
	ID            string `json:"gift_id,omitempty" field:"gift_id" ifempty:"false"`
	PayForUpgrade bool   `json:"pay_for_upgrade,omitempty" field:"pay_for_upgrade" ifempty:"false"`
}

type webhook struct {
	Url                *string  `json:"url" field:"url" ifempty:"true"`
	Certificate        string   `json:"certificate,omitempty" field:"certificate" ifempty:"false"`
	IpAddress          string   `json:"ip_address,omitempty" field:"ip_address" ifempty:"false"`
	MaxConnections     int      `json:"max_connections,omitempty" field:"max_connections" ifempty:"false"`
	AllowedUpdates     []string `json:"allowed_updates,omitempty" field:"allowed_updates" ifempty:"false"`
	DropPendingUpdates bool     `json:"drop_pending_updates,omitempty" field:"drop_pending_updates" ifempty:"false"`
	SecretToken        string   `json:"secret_token,omitempty" field:"secret_token" ifempty:"false"`
	buf                *bytes.Buffer
	contenttype        string
	token              string
	status             bool
...
type get struct {
	...
	poll       *Poll
	dice       *Dice
	uprph      *UserProfilePhotos
	file       *File
	stickers   []*Sticker
	gifts      []*Gift
	msg        *TelegramMessage
	str        string
	invlink    *ChatInviteLink
	chatinfo   *ChatFullInfo
	members    []*ChatMember
	integer    *int
	forum      *ForumTopic
	boosts     []*ChatBoost
	bconn      *BusinessConnection
	botcomm    []*BotCommand
	menuButton *MenuButton
	admin      *ChatAdministratorRights
	stickerset *StickerSet
	msgs       []*TelegramMessage
	prepinlmsg *PreparedInlineMessage
	startrans  *StarTransaction
	score      []*GameHighScore
	request    string
	response   string
}
